...
class SHIDENCORE_API UShidenMoveCanvasPanelSlotCommand : public UShidenCommandObject
{
	...
	static bool TryStartMoveSlot(const FMoveCanvasPanelSlotCommandArgs& Args, UShidenWidget* Widget, const FString& ProcessName, FString& ErrorMessage);
    
	static bool TryOverwriteZOrder(const FMoveCanvasPanelSlotCommandArgs& Args, const UShidenWidget* Widget, bool bRegisterCurrentProperty, FString& ErrorMessage);
