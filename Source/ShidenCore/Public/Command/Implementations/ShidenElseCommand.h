...
#include "ShidenElseCommand.generated.h"

UCLASS()
class SHIDENCORE_API UShidenElseCommand : public UShidenCommandObject
{
	GENERATED_BODY()
	...
	static void FindEndIfIndex(const FString& ProcessName, bool& bSuccess, FString& ErrorMessage);
};
