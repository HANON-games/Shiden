...
void SShidenRubyTextWidget::Construct(const FArguments& InArgs)
{
	...
	{
		constexpr int32 MinFontSize = 8;
		RubyStyle = *InArgs._BaseTextStyle;
		RubyStyle.Font.Size = FMath::Max(MinFontSize, FMath::RoundToInt(InArgs._BaseTextStyle->Font.Size * InArgs._SizeCoefficient));
	}
	...
	[
		...
		.VAlign(VAlign_Top)
		.Padding(0, -(CalculatedRubyHeight + RubyHeightPadding) + InArgs._OffsetCoefficient * BaseFontSize, 0, 0)
		[
