...
{
	Status = TryFindEndIfIndex(TEXT("Default"), ErrorMessage) ? EShidenPreviewStatus::Complete : EShidenPreviewStatus::Error;
}

bool UShidenElseCommand::TryFindEndIfIndex(const FString& ProcessName, FString& ErrorMessage)
{
