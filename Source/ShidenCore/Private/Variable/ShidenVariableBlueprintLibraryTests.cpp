...
struct FReplaceVariablesTestParameters
{
	FString InputText;
	...
	FReplaceVariablesTestParameters& SetInput(const FString& Text, const FString& Expected)
	{
		InputText = Text;
...
IMPLEMENT_COMPLEX_AUTOMATION_TEST(FReplaceVariablesTest, "ShidenVariableBlueprintLibrary.ReplaceVariables",
                                  EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

void FReplaceVariablesTest::GetTests(TArray<FString>& OutBeautifiedNames, TArray<FString>& OutTestCommands) const
{
	// UserVariable_String
...
bool FReplaceVariablesTest::RunTest(const FString& Parameters)
{
	...
	// Execute
	const FString Result = UShidenVariableBlueprintLibrary::ReplaceVariables(TEXT("Default"), Params.InputText);
