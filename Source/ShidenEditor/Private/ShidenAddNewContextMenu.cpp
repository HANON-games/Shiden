					...
					FNewToolMenuDelegate::CreateLambda([](UToolMenu* InMenu)
					{
						...
						ToolMenuSection.AddMenuEntry(
							...
							FUIAction(
								...
								{
									CreateAsset(TEXT("/Shiden/Samples/AC_ShidenActorSample"), TEXT("AC_MyShidenActor"));
								})
							)
						);
						...
						ToolMenuSection.AddMenuEntry(
							...
							FUIAction(
								FExecuteAction::CreateLambda([]
								{
									CreateAsset(TEXT("/Shiden/Samples/WBP_ShidenWidgetSample"), TEXT("WBP_MyShidenWidget"));
								})
							)
						);
						...
						ToolMenuSection.AddMenuEntry(
							...
							FUIAction(
								FExecuteAction::CreateLambda([]
								{
									CreateAsset(TEXT("/Shiden/Samples/WBP_ShidenTextWidgetSample"), TEXT("WBP_MyTextWidget"));
								})
							)
						);
						...
						ToolMenuSection.AddMenuEntry(
							...
							FUIAction(
								FExecuteAction::CreateLambda([]
								{
									const TObjectPtr<UObject> BacklogAsset = CreateAsset(
										TEXT("/Shiden/Samples/WBP_ShidenBacklogSample"), TEXT("WBP_MyBacklog"));
									const TObjectPtr<UObject> BacklogItemAsset = CreateAsset(
										TEXT("/Shiden/Samples/WBP_ShidenBacklogItemSample"), TEXT("WBP_MyBacklogItem"));
									...
									UShidenEditorBlueprintLibrary::SetDefaultClassProperty(
										BacklogAssetClass, FName("BacklogItemClass"), BacklogItemAssetClass);
								})
							)
						);
						...
						ToolMenuSection.AddMenuEntry(
							...
							FUIAction(
								FExecuteAction::CreateLambda([]
								{
									const TObjectPtr<UObject> SaveMenuAsset = CreateAsset(
										TEXT("/Shiden/Samples/WBP_ShidenSaveMenuSample"), TEXT("WBP_MySaveMenu"));
						...
						ToolMenuSection.AddMenuEntry(
							...
							FUIAction(
								FExecuteAction::CreateLambda([]
								{
									CreateAsset(TEXT("/Shiden/Samples/WBP_ShidenConfigMenuSample"), TEXT("WBP_MyConfigMenu"));
								})
							)
						);
							...
							FNewToolMenuDelegate::CreateLambda([](UToolMenu* InAdvancedMenu)
							{
								...
								AdvancedToolMenuSection.AddMenuEntry(
									...
									FUIAction(
										FExecuteAction::CreateLambda([]
										{
											CreateAsset(TEXT("/Shiden/Samples/BP_ShidenCommandSample"), TEXT("BP_MyCommand"));
										})
									)
								);
								...
								AdvancedToolMenuSection.AddMenuEntry(
									...
									FUIAction(
										FExecuteAction::CreateLambda([]
										{
											CreateAsset(TEXT("/Shiden/Samples/BP_ShidenTextCommandSample"), TEXT("BP_MyTextCommand"));
										})
									)
								);
								...
								AdvancedToolMenuSection.AddMenuEntry(
									...
									FUIAction(
										FExecuteAction::CreateLambda([]
										{
											CreateAssetFromClass(UShidenCommandDefinitions::StaticClass(), TEXT("DA_MyCommandDefinitions"));
										})
									)
								);
								...
								AdvancedToolMenuSection.AddMenuEntry(
									...
									FSlateIcon(FName("EditorStyle"), FName("ClassThumbnail.EditorUtilityWidgetBlueprint"),
									           FName("ClassIcon.EditorUtilityWidgetBlueprint")),
									FUIAction(
										FExecuteAction::CreateLambda([]
										{
											CreateAsset(TEXT("/Shiden/Editor/Inputs/EUW_ShidenTextInput"), TEXT("EUW_MyInput"));
										})
									)
								);
								...
								AdvancedToolMenuSection.AddMenuEntry(
									...
									FSlateIcon(FName("EditorStyle"), FName("ClassThumbnail.DataTable"), FName("ClassIcon.DataTable")),
									FUIAction(
										FExecuteAction::CreateLambda([]
										{
											CreateAsset(TEXT("/Shiden/Misc/RichText/DT_ShidenRichTextStyleRow"), TEXT("DT_MyRichTextStyleRow"));
										})
									)
								);
								...
								AdvancedToolMenuSection.AddMenuEntry(
									...
									FUIAction(
										FExecuteAction::CreateLambda([]
										{
											CreateAsset(TEXT("/Shiden/Misc/RichText/DT_ShidenRichImageRow"), TEXT("DT_MyRichImageRow"));
										})
									)
								);

								AdvancedToolMenuSection.AddMenuEntry(
									FName("CreateShidenRichTextBlockRubyDecorator"),
									FText::FromString("Shiden Rich Text Block Ruby Decorator"),
									LOCTEXT("CreateShidenRichTextBlockRubyDecoratorTooltip", "Create a new Shiden Rich Text Block Ruby Decorator"),
									FSlateIcon(FName("EditorStyle"), FName("ClassThumbnail.Blueprint"), FName("ClassIcon.Blueprint")),
									FUIAction(
										FExecuteAction::CreateLambda([]
										{
											CreateAsset(
												TEXT("/Shiden/Misc/RichText/BP_ShidenRichTextBlockRubyDecorator"),
												TEXT("BP_MyRichTextBlockRubyDecorator"));
										})
									)
								);
								...
								AdvancedToolMenuSection.AddMenuEntry(
									...
									FUIAction(
										FExecuteAction::CreateLambda([]
										{
											CreateAssetFromClass(UShidenCommandRedirectors::StaticClass(), TEXT("DT_MyCommandRedirectors"));
										})
									)
								);
							})
