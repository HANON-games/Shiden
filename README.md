...
[![X (formerly Twitter) Follow](https://img.shields.io/twitter/follow/HanonHeartKnows?style=social)](https://twitter.com/HanonHeartKnows)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/HANON-games/Shiden)
[![View Code Wiki](https://assets.codewiki.google/readme-badge/static.svg)](https://codewiki.google/github.com/hanon-games/shiden)

# Shiden Visual Novel Editor

[Japanese](https://github.com/HANON-games/Shiden/blob/main/README_ja.md) / English
...
![Shiden Visual Novel Editor](https://github.com/user-attachments/assets/24a25cbf-6301-4a0c-ac84-8f595ddfd055)

## Development Phase

Shiden Visual Novel Editor has completed the additional feature development and is now transitioning into the **maintenance phase**.

I follow these development guidelines:

| Area | Policy |
|---|---|
| Unreal Engine version support | ✅ Ongoing |
| Bug fixes | ✅ Ongoing |
| Performance improvements | ✅ Ongoing |
| New features | Not planned (in principle) |
...
- Various features required for visual novel games
    ...
    - Simple gallery mode functionality
- High extensibility
...
[葉乃音 (HANON)](https://x.com/HanonHeartKnows)
