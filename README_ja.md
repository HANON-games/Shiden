...
Japanese / [English](https://github.com/HANON-games/Shiden/blob/main/README.md)
...
Shiden Visual Novel Editor は現在、機能の追加開発が終わり**メンテナンスフェーズ**に移行しています。

以下の方針で開発を継続します：

| 対応内容 | 方針 |
|---|---|
| Unreal Engine 新バージョンへの対応 | ✅ 継続対応 |
| 不具合の修正 | ✅ 継続対応 |
| パフォーマンスの改善 | ✅ 継続対応 |
| 新機能の追加 | 原則として行いません |
